...
class StoreVideoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Dosyalar
            'video' => 'required|file|mimetypes:video/mp4,video/mpeg,video/quicktime,video/x-msvideo|max:512000', // 500MB
    ...
    public function messages(): array
    {
        return [
            ...
            'video.required' => 'Video dosyası zorunludur.',
    ...
    {
        // is_premium checkbox değerini boolean'a çevir
